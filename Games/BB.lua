...
Notify.Event:Connect(function(Text)
    Parvus.Utilities.UI:Toast(Text)
end)
        ...
        if AmmoValue > 0 then
            ...
            if (AmmoValue - Ammo.Value) >= 1 then
                ...
                if Window.Flags["BB/BulletTracer/Enabled"] then
                    Parvus.Utilities.MakeBeam(ReticlePosition, RayPosition, Window.Flags["BB/BulletTracer/Color"])
                end
            end
        else
...
local function KnifeAura()
    ...
    if Weapon and (Config and Config.Controller == "Melee") then
        ...
        if (BodyPart.Position - Origin.Position).Magnitude <= 15 then
            ...
            if Window.Flags["BB/BulletTracer/Enabled"] then
                Parvus.Utilities.MakeBeam(Origin.Position, BodyPart.Position, Window.Flags["BB/BulletTracer/Color"])
            end
